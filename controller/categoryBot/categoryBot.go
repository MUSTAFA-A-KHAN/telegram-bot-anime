	...
	if message.Chat.IsPrivate() {
		...
		case "rules":
			rulesText := "🎮 *Game Rules*\n\n" +
				"👥 *Players*\n" +
				"⌨️ — Guess the word by typing your answer.\n" +
